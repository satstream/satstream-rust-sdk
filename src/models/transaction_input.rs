...
impl TransactionInput {
  ...
  pub fn with_previous_output(mut self, previous_output: String) -> TransactionInput {
    self.previous_output = Some(previous_output);
    self
  }
  ...
  pub fn with_script_sig(mut self, script_sig: String) -> TransactionInput {
    self.script_sig = Some(script_sig);
    self
  }
  ...
  pub fn with_sequence(mut self, sequence: i32) -> TransactionInput {
    self.sequence = Some(sequence);
    self
  }
  ...
  pub fn with_witness(mut self, witness: Vec<String>) -> TransactionInput {
    self.witness = Some(witness);
    self
  }
