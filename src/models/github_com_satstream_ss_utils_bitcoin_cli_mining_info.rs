...
pub struct GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
  /// The current block
  #[serde(rename = "blocks")]
  blocks: Option<i32>,
...
impl GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
  pub fn new() -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
  ...
  pub fn with_blocks(mut self, blocks: i32) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.blocks = Some(blocks);
    self
  }
  ...
  pub fn with_chain(mut self, chain: String) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.chain = Some(chain);
    self
  }
  ...
  pub fn with_currentblocktx(mut self, currentblocktx: i32) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.currentblocktx = Some(currentblocktx);
    self
  }
  ...
  pub fn with_currentblockweight(mut self, currentblockweight: i32) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.currentblockweight = Some(currentblockweight);
    self
  }
  ...
  pub fn with_difficulty(mut self, difficulty: f32) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.difficulty = Some(difficulty);
    self
  }
  ...
  pub fn with_networkhashps(mut self, networkhashps: f32) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.networkhashps = Some(networkhashps);
    self
  }
  ...
  pub fn with_pooledtx(mut self, pooledtx: i32) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.pooledtx = Some(pooledtx);
    self
  }
  ...
  pub fn with_warnings(mut self, warnings: String) -> GithubComSatstreamSsUtilsBitcoinCliMiningInfo {
    self.warnings = Some(warnings);
    self
  }
