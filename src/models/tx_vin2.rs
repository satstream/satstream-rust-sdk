...
impl TxVin2 {
  ...
  pub fn with_coinbase(mut self, coinbase: String) -> TxVin2 {
    self.coinbase = Some(coinbase);
    self
  }
  ...
  pub fn set_prevout(&mut self, prevout: ::models::PrevOut) {
    self.prevout = Some(prevout);
  }

  pub fn with_prevout(mut self, prevout: ::models::PrevOut) -> TxVin2 {
    self.prevout = Some(prevout);
    self
  }

  pub fn prevout(&self) -> Option<&::models::PrevOut> {
    self.prevout.as_ref()
  }
  ...
  pub fn with_script_sig(mut self, script_sig: ::models::ScriptSig) -> TxVin2 {
    self.script_sig = Some(script_sig);
    self
  }
  ...
  pub fn with_sequence(mut self, sequence: i32) -> TxVin2 {
    self.sequence = Some(sequence);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> TxVin2 {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_txinwitness(mut self, txinwitness: Vec<String>) -> TxVin2 {
    self.txinwitness = Some(txinwitness);
    self
  }
  ...
  pub fn with_vout(mut self, vout: i32) -> TxVin2 {
    self.vout = Some(vout);
    self
  }
