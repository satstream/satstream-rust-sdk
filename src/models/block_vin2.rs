...
pub struct BlockVin2 {
  /// Coinbase transaction input
  #[serde(rename = "coinbase")]
  coinbase: Option<String>,
  #[serde(rename = "scriptSig")]
  script_sig: Option<::models::BlockVin2ScriptSig>,
...
impl BlockVin2 {
  ...
  pub fn with_coinbase(mut self, coinbase: String) -> BlockVin2 {
    self.coinbase = Some(coinbase);
    self
  }
  ...
  pub fn set_script_sig(&mut self, script_sig: ::models::BlockVin2ScriptSig) {
    self.script_sig = Some(script_sig);
  }

  pub fn with_script_sig(mut self, script_sig: ::models::BlockVin2ScriptSig) -> BlockVin2 {
    self.script_sig = Some(script_sig);
    self
  }

  pub fn script_sig(&self) -> Option<&::models::BlockVin2ScriptSig> {
  ...
  pub fn with_sequence(mut self, sequence: i32) -> BlockVin2 {
    self.sequence = Some(sequence);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> BlockVin2 {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_txinwitness(mut self, txinwitness: Vec<String>) -> BlockVin2 {
    self.txinwitness = Some(txinwitness);
    self
  }
  ...
  pub fn with_vout(mut self, vout: i32) -> BlockVin2 {
    self.vout = Some(vout);
    self
  }
