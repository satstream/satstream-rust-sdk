...
impl InlineResponse20039 {
  ...
  pub fn set_data(&mut self, data: ::models::RawTx1) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::RawTx1) -> InlineResponse20039 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::RawTx1> {
    self.data.as_ref()
  }
