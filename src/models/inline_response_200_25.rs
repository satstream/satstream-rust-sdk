...
pub struct InlineResponse20025 {
  #[serde(rename = "data")]
  data: Option<::models::OutputResponse>,
...
impl InlineResponse20025 {
  ...
  pub fn set_data(&mut self, data: ::models::OutputResponse) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::OutputResponse) -> InlineResponse20025 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::OutputResponse> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20025 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
