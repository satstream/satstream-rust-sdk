...
pub struct InlineResponse20029 {
  #[serde(rename = "data")]
  data: Option<::models::RuneResponse>,
...
impl InlineResponse20029 {
  ...
  pub fn set_data(&mut self, data: ::models::RuneResponse) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::RuneResponse) -> InlineResponse20029 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::RuneResponse> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20029 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
