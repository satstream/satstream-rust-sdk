...
impl Script {
  ...
  pub fn with_address(mut self, address: String) -> Script {
    self.address = Some(address);
    self
  }
  ...
  pub fn with_asm(mut self, asm: String) -> Script {
    self.asm = Some(asm);
    self
  }
  ...
  pub fn with_hex(mut self, hex: String) -> Script {
    self.hex = Some(hex);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> Script {
    self._type = Some(_type);
    self
  }
