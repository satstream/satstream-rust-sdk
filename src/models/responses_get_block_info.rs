...
pub struct ResponsesGetBlockInfo {
  #[serde(rename = "code")]
  code: Option<i32>,
  #[serde(rename = "data")]
...
impl ResponsesGetBlockInfo {
  ...
  pub fn with_code(mut self, code: i32) -> ResponsesGetBlockInfo {
    self.code = Some(code);
    self
  }
  ...
  pub fn with_data(mut self, data: ::models::GithubComSatstreamSsUtilsRpcBlock) -> ResponsesGetBlockInfo {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_msg(mut self, msg: String) -> ResponsesGetBlockInfo {
    self.msg = Some(msg);
    self
  }
