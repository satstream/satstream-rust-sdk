...
impl TxSpendingPrevoutResult {
  pub fn new() -> TxSpendingPrevoutResult {
  ...
  pub fn with_spendingtxid(mut self, spendingtxid: String) -> TxSpendingPrevoutResult {
    self.spendingtxid = Some(spendingtxid);
    self
  }
  ...
  pub fn with_spent(mut self, spent: bool) -> TxSpendingPrevoutResult {
    self.spent = Some(spent);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> TxSpendingPrevoutResult {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_vout(mut self, vout: i32) -> TxSpendingPrevoutResult {
    self.vout = Some(vout);
    self
  }
