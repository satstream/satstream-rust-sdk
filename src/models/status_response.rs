...
pub struct StatusResponse {
  ...
  initial_sync_time: Option<::models::Duration>,
...
impl StatusResponse {
  ...
  pub fn with_address_index(mut self, address_index: bool) -> StatusResponse {
    self.address_index = Some(address_index);
    self
  }
  ...
  pub fn with_blessed_inscriptions(mut self, blessed_inscriptions: i32) -> StatusResponse {
    self.blessed_inscriptions = Some(blessed_inscriptions);
    self
  }
  ...
  pub fn with_chain(mut self, chain: String) -> StatusResponse {
    self.chain = Some(chain);
    self
  }
  ...
  pub fn with_cursed_inscriptions(mut self, cursed_inscriptions: i32) -> StatusResponse {
    self.cursed_inscriptions = Some(cursed_inscriptions);
    self
  }
  ...
  pub fn with_height(mut self, height: i32) -> StatusResponse {
    self.height = Some(height);
    self
  }
  ...
  pub fn set_initial_sync_time(&mut self, initial_sync_time: ::models::Duration) {
    self.initial_sync_time = Some(initial_sync_time);
  }

  pub fn with_initial_sync_time(mut self, initial_sync_time: ::models::Duration) -> StatusResponse {
    self.initial_sync_time = Some(initial_sync_time);
    self
  }

  pub fn initial_sync_time(&self) -> Option<&::models::Duration> {
  ...
  pub fn with_inscriptions(mut self, inscriptions: i32) -> StatusResponse {
    self.inscriptions = Some(inscriptions);
    self
  }
  ...
  pub fn with_lost_sats(mut self, lost_sats: i32) -> StatusResponse {
    self.lost_sats = Some(lost_sats);
    self
  }
  ...
  pub fn with_minimum_rune_for_next_block(mut self, minimum_rune_for_next_block: String) -> StatusResponse {
    self.minimum_rune_for_next_block = Some(minimum_rune_for_next_block);
    self
  }
  ...
  pub fn with_rune_index(mut self, rune_index: bool) -> StatusResponse {
    self.rune_index = Some(rune_index);
    self
  }
  ...
  pub fn with_runes(mut self, runes: i32) -> StatusResponse {
    self.runes = Some(runes);
    self
  }
  ...
  pub fn with_sat_index(mut self, sat_index: bool) -> StatusResponse {
    self.sat_index = Some(sat_index);
    self
  }
  ...
  pub fn with_started(mut self, started: String) -> StatusResponse {
    self.started = Some(started);
    self
  }
  ...
  pub fn with_transaction_index(mut self, transaction_index: bool) -> StatusResponse {
    self.transaction_index = Some(transaction_index);
    self
  }
  ...
  pub fn with_unrecoverably_reorged(mut self, unrecoverably_reorged: bool) -> StatusResponse {
    self.unrecoverably_reorged = Some(unrecoverably_reorged);
    self
  }
  ...
  pub fn set_uptime(&mut self, uptime: ::models::Duration) {
    self.uptime = Some(uptime);
  }

  pub fn with_uptime(mut self, uptime: ::models::Duration) -> StatusResponse {
    self.uptime = Some(uptime);
    self
  }

  pub fn uptime(&self) -> Option<&::models::Duration> {
    self.uptime.as_ref()
  }
