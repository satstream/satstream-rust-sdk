...
pub struct InlineResponse20022 {
  #[serde(rename = "data")]
  data: Option<::models::RawMempoolData>,
...
impl InlineResponse20022 {
  ...
  pub fn set_data(&mut self, data: ::models::RawMempoolData) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::RawMempoolData) -> InlineResponse20022 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::RawMempoolData> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20022 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
