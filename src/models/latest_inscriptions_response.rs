...
pub struct LatestInscriptionsResponse {
  #[serde(rename = "ids")]
...
impl LatestInscriptionsResponse {
  pub fn new() -> LatestInscriptionsResponse {
  ...
  pub fn with_ids(mut self, ids: Vec<String>) -> LatestInscriptionsResponse {
    self.ids = Some(ids);
    self
  }
  ...
  pub fn with_more(mut self, more: bool) -> LatestInscriptionsResponse {
    self.more = Some(more);
    self
  }
  ...
  pub fn with_page_index(mut self, page_index: i32) -> LatestInscriptionsResponse {
    self.page_index = Some(page_index);
    self
  }
