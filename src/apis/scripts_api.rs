...
pub struct ScriptsApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> ScriptsApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ScriptsApiClient<C> {
        ScriptsApiClient {
