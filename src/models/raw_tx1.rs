...
impl RawTx1 {
  ...
  pub fn with_blockhash(mut self, blockhash: String) -> RawTx1 {
    self.blockhash = Some(blockhash);
    self
  }
  ...
  pub fn with_blocktime(mut self, blocktime: i32) -> RawTx1 {
    self.blocktime = Some(blocktime);
    self
  }
  ...
  pub fn with_confirmations(mut self, confirmations: i32) -> RawTx1 {
    self.confirmations = Some(confirmations);
    self
  }
  ...
  pub fn with_hash(mut self, hash: String) -> RawTx1 {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_hex(mut self, hex: String) -> RawTx1 {
    self.hex = Some(hex);
    self
  }
  ...
  pub fn with_locktime(mut self, locktime: i32) -> RawTx1 {
    self.locktime = Some(locktime);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> RawTx1 {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_time(mut self, time: i32) -> RawTx1 {
    self.time = Some(time);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> RawTx1 {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_version(mut self, version: i32) -> RawTx1 {
    self.version = Some(version);
    self
  }
  ...
  pub fn set_vin(&mut self, vin: Vec<::models::TxVin1>) {
    self.vin = Some(vin);
  }

  pub fn with_vin(mut self, vin: Vec<::models::TxVin1>) -> RawTx1 {
    self.vin = Some(vin);
    self
  }

  pub fn vin(&self) -> Option<&Vec<::models::TxVin1>> {
    self.vin.as_ref()
  }
  ...
  pub fn with_vout(mut self, vout: Vec<::models::Vout>) -> RawTx1 {
    self.vout = Some(vout);
    self
  }
  ...
  pub fn with_vsize(mut self, vsize: i32) -> RawTx1 {
    self.vsize = Some(vsize);
    self
  }
  ...
  pub fn with_weight(mut self, weight: i32) -> RawTx1 {
    self.weight = Some(weight);
    self
  }
