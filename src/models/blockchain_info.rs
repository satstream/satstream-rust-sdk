...
impl BlockchainInfo {
  ...
  pub fn with_bestblockhash(mut self, bestblockhash: String) -> BlockchainInfo {
    self.bestblockhash = Some(bestblockhash);
    self
  }
  ...
  pub fn with_blocks(mut self, blocks: i32) -> BlockchainInfo {
    self.blocks = Some(blocks);
    self
  }
  ...
  pub fn with_chain(mut self, chain: String) -> BlockchainInfo {
    self.chain = Some(chain);
    self
  }
  ...
  pub fn with_chainwork(mut self, chainwork: String) -> BlockchainInfo {
    self.chainwork = Some(chainwork);
    self
  }
  ...
  pub fn with_difficulty(mut self, difficulty: f32) -> BlockchainInfo {
    self.difficulty = Some(difficulty);
    self
  }
  ...
  pub fn with_headers(mut self, headers: i32) -> BlockchainInfo {
    self.headers = Some(headers);
    self
  }
  ...
  pub fn with_mediantime(mut self, mediantime: i32) -> BlockchainInfo {
    self.mediantime = Some(mediantime);
    self
  }
  ...
  pub fn with_time(mut self, time: i32) -> BlockchainInfo {
    self.time = Some(time);
    self
  }
