...
pub struct InlineResponse20038 {
  #[serde(rename = "data")]
  data: Option<::models::TransactionResponse>,
...
impl InlineResponse20038 {
  ...
  pub fn set_data(&mut self, data: ::models::TransactionResponse) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::TransactionResponse) -> InlineResponse20038 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::TransactionResponse> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20038 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
