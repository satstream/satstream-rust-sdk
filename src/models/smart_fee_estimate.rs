...
impl SmartFeeEstimate {
  ...
  pub fn with_blocks(mut self, blocks: i32) -> SmartFeeEstimate {
    self.blocks = Some(blocks);
    self
  }
  ...
  pub fn with_errors(mut self, errors: Vec<String>) -> SmartFeeEstimate {
    self.errors = Some(errors);
    self
  }
  ...
  pub fn with_feerate(mut self, feerate: f32) -> SmartFeeEstimate {
    self.feerate = Some(feerate);
    self
  }
