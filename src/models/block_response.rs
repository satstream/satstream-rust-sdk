...
pub struct BlockResponse {
  ...
  transactions: Option<Vec<::models::Transaction>>
}
...
impl BlockResponse {
  ...
  pub fn with_best_height(mut self, best_height: i32) -> BlockResponse {
    self.best_height = Some(best_height);
    self
  }
  ...
  pub fn with_hash(mut self, hash: String) -> BlockResponse {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_height(mut self, height: i32) -> BlockResponse {
    self.height = Some(height);
    self
  }
  ...
  pub fn with_inscriptions(mut self, inscriptions: Vec<String>) -> BlockResponse {
    self.inscriptions = Some(inscriptions);
    self
  }
  ...
  pub fn with_runes(mut self, runes: Vec<String>) -> BlockResponse {
    self.runes = Some(runes);
    self
  }
  ...
  pub fn with_target(mut self, target: String) -> BlockResponse {
    self.target = Some(target);
    self
  }
  ...
  pub fn set_transactions(&mut self, transactions: Vec<::models::Transaction>) {
    self.transactions = Some(transactions);
  }

  pub fn with_transactions(mut self, transactions: Vec<::models::Transaction>) -> BlockResponse {
    self.transactions = Some(transactions);
    self
  }

  pub fn transactions(&self) -> Option<&Vec<::models::Transaction>> {
