...
pub struct OutputsApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> OutputsApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> OutputsApiClient<C> {
        OutputsApiClient {
...
impl<C: hyper::client::Connect>OutputsApi for OutputsApiClient<C> {
    fn get_output_by_outpoint(&self, outpoint: &str) -> Box<Future<Item = ::models::InlineResponse20025, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/output/{outpoint}?{}", configuration.base_path, query_string, outpoint=outpoint);
