...
impl InlineResponse20040 {
  ...
  pub fn with_data(mut self, data: ::models::RawTx1) -> InlineResponse20040 {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20040 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
