...
pub struct InlineResponse20031 {
  #[serde(rename = "data")]
  data: Option<::models::DecodedScript>,
...
impl InlineResponse20031 {
  ...
  pub fn set_data(&mut self, data: ::models::DecodedScript) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::DecodedScript) -> InlineResponse20031 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::DecodedScript> {
    self.data.as_ref()
  }
