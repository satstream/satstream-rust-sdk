...
pub trait NetworkApi {
    fn get_chain_tx_stats(&self, request: ::models::RequestsGetChainTxStatsRequest) -> Box<Future<Item = ::models::InlineResponse20014, Error = Error<serde_json::Value>>>;
    fn get_difficulty(&self, ) -> Box<Future<Item = ::models::InlineResponse20013, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>NetworkApi for NetworkApiClient<C> {
    ...
    fn get_difficulty(&self, ) -> Box<Future<Item = ::models::InlineResponse20013, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/chain/difficulty?{}", configuration.base_path, query_string);
