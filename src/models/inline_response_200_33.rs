...
impl InlineResponse20033 {
  ...
  pub fn set_data(&mut self, data: ::models::TxOut) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::TxOut) -> InlineResponse20033 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::TxOut> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20033 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
