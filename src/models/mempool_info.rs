...
impl MempoolInfo {
  ...
  pub fn with_bytes(mut self, bytes: i32) -> MempoolInfo {
    self.bytes = Some(bytes);
    self
  }
  ...
  pub fn with_fullrbf(mut self, fullrbf: bool) -> MempoolInfo {
    self.fullrbf = Some(fullrbf);
    self
  }
  ...
  pub fn with_incrementalrelayfee(mut self, incrementalrelayfee: f32) -> MempoolInfo {
    self.incrementalrelayfee = Some(incrementalrelayfee);
    self
  }
  ...
  pub fn with_loaded(mut self, loaded: bool) -> MempoolInfo {
    self.loaded = Some(loaded);
    self
  }
  ...
  pub fn with_maxmempool(mut self, maxmempool: i32) -> MempoolInfo {
    self.maxmempool = Some(maxmempool);
    self
  }
  ...
  pub fn with_mempoolminfee(mut self, mempoolminfee: f32) -> MempoolInfo {
    self.mempoolminfee = Some(mempoolminfee);
    self
  }
  ...
  pub fn with_minrelaytxfee(mut self, minrelaytxfee: f32) -> MempoolInfo {
    self.minrelaytxfee = Some(minrelaytxfee);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> MempoolInfo {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_total_fee(mut self, total_fee: f32) -> MempoolInfo {
    self.total_fee = Some(total_fee);
    self
  }
  ...
  pub fn with_unbroadcastcount(mut self, unbroadcastcount: i32) -> MempoolInfo {
    self.unbroadcastcount = Some(unbroadcastcount);
    self
  }
  ...
  pub fn with_usage(mut self, usage: i32) -> MempoolInfo {
    self.usage = Some(usage);
    self
  }
