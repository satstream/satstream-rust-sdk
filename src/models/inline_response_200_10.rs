...
pub struct InlineResponse20010 {
  #[serde(rename = "data")]
  data: Option<::models::BlockchainInfo>,
...
impl InlineResponse20010 {
  ...
  pub fn set_data(&mut self, data: ::models::BlockchainInfo) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::BlockchainInfo) -> InlineResponse20010 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::BlockchainInfo> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20010 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
