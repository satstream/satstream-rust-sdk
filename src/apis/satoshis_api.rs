...
pub struct SatoshisApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> SatoshisApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> SatoshisApiClient<C> {
        SatoshisApiClient {
