...
pub struct BtcTx2 {
  ...
  version: Option<i32>,
  #[serde(rename = "vin")]
  vin: Option<Vec<::models::BlockVin2>>,
  #[serde(rename = "vout")]
...
impl BtcTx2 {
  ...
  pub fn with_fee(mut self, fee: f32) -> BtcTx2 {
    self.fee = Some(fee);
    self
  }
  ...
  pub fn with_hash(mut self, hash: String) -> BtcTx2 {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_hex(mut self, hex: String) -> BtcTx2 {
    self.hex = Some(hex);
    self
  }
  ...
  pub fn with_locktime(mut self, locktime: i32) -> BtcTx2 {
    self.locktime = Some(locktime);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> BtcTx2 {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> BtcTx2 {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_version(mut self, version: i32) -> BtcTx2 {
    self.version = Some(version);
    self
  }
  ...
  pub fn set_vin(&mut self, vin: Vec<::models::BlockVin2>) {
    self.vin = Some(vin);
  }

  pub fn with_vin(mut self, vin: Vec<::models::BlockVin2>) -> BtcTx2 {
    self.vin = Some(vin);
    self
  }

  pub fn vin(&self) -> Option<&Vec<::models::BlockVin2>> {
    self.vin.as_ref()
  }
  ...
  pub fn with_vout(mut self, vout: Vec<::models::Vout>) -> BtcTx2 {
    self.vout = Some(vout);
    self
  }
  ...
  pub fn with_vsize(mut self, vsize: i32) -> BtcTx2 {
    self.vsize = Some(vsize);
    self
  }
  ...
  pub fn with_weight(mut self, weight: i32) -> BtcTx2 {
    self.weight = Some(weight);
    self
  }
