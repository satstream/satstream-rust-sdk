...
pub struct InlineResponse20039 {
  #[serde(rename = "data")]
  data: Option<::models::DecodeResponse>,
...
impl InlineResponse20039 {
  ...
  pub fn set_data(&mut self, data: ::models::DecodeResponse) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::DecodeResponse) -> InlineResponse20039 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::DecodeResponse> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20039 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
