...
pub struct UtxoBlockInfo {
  ...
  unspendables: Option<::models::UtxoBlockInfoUnspendables>
}

impl UtxoBlockInfo {
  pub fn new() -> UtxoBlockInfo {
    UtxoBlockInfo {
      coinbase: None,
  ...
  pub fn with_coinbase(mut self, coinbase: f32) -> UtxoBlockInfo {
    self.coinbase = Some(coinbase);
    self
  }
  ...
  pub fn with_new_outputs_ex_coinbase(mut self, new_outputs_ex_coinbase: f32) -> UtxoBlockInfo {
    self.new_outputs_ex_coinbase = Some(new_outputs_ex_coinbase);
    self
  }
  ...
  pub fn with_prevout_spent(mut self, prevout_spent: f32) -> UtxoBlockInfo {
    self.prevout_spent = Some(prevout_spent);
    self
  }
  ...
  pub fn with_unspendable(mut self, unspendable: f32) -> UtxoBlockInfo {
    self.unspendable = Some(unspendable);
    self
  }
  ...
  pub fn set_unspendables(&mut self, unspendables: ::models::UtxoBlockInfoUnspendables) {
    self.unspendables = Some(unspendables);
  }

  pub fn with_unspendables(mut self, unspendables: ::models::UtxoBlockInfoUnspendables) -> UtxoBlockInfo {
    self.unspendables = Some(unspendables);
    self
  }

  pub fn unspendables(&self) -> Option<&::models::UtxoBlockInfoUnspendables> {
