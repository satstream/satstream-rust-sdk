...
pub struct InlineResponse20016 {
  #[serde(rename = "data")]
  data: Option<::models::SmartFeeEstimate>,
...
impl InlineResponse20016 {
  ...
  pub fn set_data(&mut self, data: ::models::SmartFeeEstimate) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::SmartFeeEstimate) -> InlineResponse20016 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::SmartFeeEstimate> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20016 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
