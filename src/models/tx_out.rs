...
pub struct TxOut {
  ...
  script_pub_key: Option<::models::TxOutScriptPubKey>,
...
impl TxOut {
  ...
  pub fn with_bestblock(mut self, bestblock: String) -> TxOut {
    self.bestblock = Some(bestblock);
    self
  }
  ...
  pub fn with_coinbase(mut self, coinbase: bool) -> TxOut {
    self.coinbase = Some(coinbase);
    self
  }
  ...
  pub fn with_confirmations(mut self, confirmations: i32) -> TxOut {
    self.confirmations = Some(confirmations);
    self
  }
  ...
  pub fn set_script_pub_key(&mut self, script_pub_key: ::models::TxOutScriptPubKey) {
    self.script_pub_key = Some(script_pub_key);
  }

  pub fn with_script_pub_key(mut self, script_pub_key: ::models::TxOutScriptPubKey) -> TxOut {
    self.script_pub_key = Some(script_pub_key);
    self
  }

  pub fn script_pub_key(&self) -> Option<&::models::TxOutScriptPubKey> {
  ...
  pub fn with_value(mut self, value: f32) -> TxOut {
    self.value = Some(value);
    self
  }
