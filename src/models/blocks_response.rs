...
impl BlocksResponse {
  ...
  pub fn with_blocks(mut self, blocks: Vec<String>) -> BlocksResponse {
    self.blocks = Some(blocks);
    self
  }
  ...
  pub fn with_featured_blocks(mut self, featured_blocks: ::std::collections::HashMap<String, Vec<String>>) -> BlocksResponse {
    self.featured_blocks = Some(featured_blocks);
    self
  }
  ...
  pub fn with_last(mut self, last: i32) -> BlocksResponse {
    self.last = Some(last);
    self
  }
