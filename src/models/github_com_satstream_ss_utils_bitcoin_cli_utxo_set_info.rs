...
pub struct GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
  /// The hash of the block at which these statistics are calculated
  #[serde(rename = "bestblock")]
  bestblock: Option<String>,
  #[serde(rename = "block_info")]
  block_info: Option<::models::GithubComSatstreamSsutilsBitcoincliUtxoSetInfoBlockInfo>,
...
impl GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
  pub fn new() -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
  ...
  pub fn with_bestblock(mut self, bestblock: String) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.bestblock = Some(bestblock);
    self
  }
  ...
  pub fn set_block_info(&mut self, block_info: ::models::GithubComSatstreamSsutilsBitcoincliUtxoSetInfoBlockInfo) {
    self.block_info = Some(block_info);
  }

  pub fn with_block_info(mut self, block_info: ::models::GithubComSatstreamSsutilsBitcoincliUtxoSetInfoBlockInfo) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.block_info = Some(block_info);
    self
  }

  pub fn block_info(&self) -> Option<&::models::GithubComSatstreamSsutilsBitcoincliUtxoSetInfoBlockInfo> {
  ...
  pub fn with_bogosize(mut self, bogosize: i32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.bogosize = Some(bogosize);
    self
  }
  ...
  pub fn with_disk_size(mut self, disk_size: i32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.disk_size = Some(disk_size);
    self
  }
  ...
  pub fn with_hash_serialized_2(mut self, hash_serialized_2: String) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.hash_serialized_2 = Some(hash_serialized_2);
    self
  }
  ...
  pub fn with_height(mut self, height: i32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.height = Some(height);
    self
  }
  ...
  pub fn with_muhash(mut self, muhash: String) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.muhash = Some(muhash);
    self
  }
  ...
  pub fn with_total_amount(mut self, total_amount: f32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.total_amount = Some(total_amount);
    self
  }
  ...
  pub fn with_total_unspendable_amount(mut self, total_unspendable_amount: f32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.total_unspendable_amount = Some(total_unspendable_amount);
    self
  }
  ...
  pub fn with_transactions(mut self, transactions: i32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.transactions = Some(transactions);
    self
  }
  ...
  pub fn with_txouts(mut self, txouts: i32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoSetInfo {
    self.txouts = Some(txouts);
    self
  }
