...
impl InlineResponse2004 {
  ...
  pub fn set_data(&mut self, data: ::models::Block2) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::Block2) -> InlineResponse2004 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::Block2> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse2004 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
