...
impl InlineResponse200 {
  ...
  pub fn with_data(mut self, data: bool) -> InlineResponse200 {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse200 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
