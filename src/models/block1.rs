...
impl Block1 {
  ...
  pub fn with_bits(mut self, bits: String) -> Block1 {
    self.bits = Some(bits);
    self
  }
  ...
  pub fn with_chainwork(mut self, chainwork: String) -> Block1 {
    self.chainwork = Some(chainwork);
    self
  }
  ...
  pub fn with_confirmations(mut self, confirmations: i32) -> Block1 {
    self.confirmations = Some(confirmations);
    self
  }
  ...
  pub fn with_difficulty(mut self, difficulty: f32) -> Block1 {
    self.difficulty = Some(difficulty);
    self
  }
  ...
  pub fn with_hash(mut self, hash: String) -> Block1 {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_height(mut self, height: i32) -> Block1 {
    self.height = Some(height);
    self
  }
  ...
  pub fn with_mediantime(mut self, mediantime: i32) -> Block1 {
    self.mediantime = Some(mediantime);
    self
  }
  ...
  pub fn with_merkleroot(mut self, merkleroot: String) -> Block1 {
    self.merkleroot = Some(merkleroot);
    self
  }
  ...
  pub fn with_n_tx(mut self, n_tx: i32) -> Block1 {
    self.n_tx = Some(n_tx);
    self
  }
  ...
  pub fn with_nextblockhash(mut self, nextblockhash: String) -> Block1 {
    self.nextblockhash = Some(nextblockhash);
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i32) -> Block1 {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_previousblockhash(mut self, previousblockhash: String) -> Block1 {
    self.previousblockhash = Some(previousblockhash);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> Block1 {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_strippedsize(mut self, strippedsize: i32) -> Block1 {
    self.strippedsize = Some(strippedsize);
    self
  }
  ...
  pub fn with_time(mut self, time: i32) -> Block1 {
    self.time = Some(time);
    self
  }
  ...
  pub fn with_tx(mut self, tx: Vec<String>) -> Block1 {
    self.tx = Some(tx);
    self
  }
  ...
  pub fn with_version(mut self, version: i32) -> Block1 {
    self.version = Some(version);
    self
  }
  ...
  pub fn with_version_hex(mut self, version_hex: String) -> Block1 {
    self.version_hex = Some(version_hex);
    self
  }
  ...
  pub fn with_weight(mut self, weight: i32) -> Block1 {
    self.weight = Some(weight);
    self
  }
