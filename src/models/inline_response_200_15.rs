...
pub struct InlineResponse20015 {
  #[serde(rename = "data")]
  data: Option<::models::RawFeeEstimate>,
...
impl InlineResponse20015 {
  ...
  pub fn set_data(&mut self, data: ::models::RawFeeEstimate) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::RawFeeEstimate) -> InlineResponse20015 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::RawFeeEstimate> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20015 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
