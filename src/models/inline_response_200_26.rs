...
impl InlineResponse20026 {
  ...
  pub fn with_data(mut self, data: ::models::OutputResponse) -> InlineResponse20026 {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20026 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
