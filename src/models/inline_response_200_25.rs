...
impl InlineResponse20025 {
  ...
  pub fn set_data(&mut self, data: ::models::MiningInfo) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MiningInfo) -> InlineResponse20025 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MiningInfo> {
    self.data.as_ref()
  }
