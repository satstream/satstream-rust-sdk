...
impl Block3 {
  ...
  pub fn with_bits(mut self, bits: String) -> Block3 {
    self.bits = Some(bits);
    self
  }
  ...
  pub fn with_chainwork(mut self, chainwork: String) -> Block3 {
    self.chainwork = Some(chainwork);
    self
  }
  ...
  pub fn with_confirmations(mut self, confirmations: i32) -> Block3 {
    self.confirmations = Some(confirmations);
    self
  }
  ...
  pub fn with_difficulty(mut self, difficulty: f32) -> Block3 {
    self.difficulty = Some(difficulty);
    self
  }
  ...
  pub fn with_hash(mut self, hash: String) -> Block3 {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_height(mut self, height: i32) -> Block3 {
    self.height = Some(height);
    self
  }
  ...
  pub fn with_mediantime(mut self, mediantime: i32) -> Block3 {
    self.mediantime = Some(mediantime);
    self
  }
  ...
  pub fn with_merkleroot(mut self, merkleroot: String) -> Block3 {
    self.merkleroot = Some(merkleroot);
    self
  }
  ...
  pub fn with_n_tx(mut self, n_tx: i32) -> Block3 {
    self.n_tx = Some(n_tx);
    self
  }
  ...
  pub fn with_nextblockhash(mut self, nextblockhash: String) -> Block3 {
    self.nextblockhash = Some(nextblockhash);
    self
  }
  ...
  pub fn with_nonce(mut self, nonce: i32) -> Block3 {
    self.nonce = Some(nonce);
    self
  }
  ...
  pub fn with_previousblockhash(mut self, previousblockhash: String) -> Block3 {
    self.previousblockhash = Some(previousblockhash);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> Block3 {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_strippedsize(mut self, strippedsize: i32) -> Block3 {
    self.strippedsize = Some(strippedsize);
    self
  }
  ...
  pub fn with_time(mut self, time: i32) -> Block3 {
    self.time = Some(time);
    self
  }
  ...
  pub fn set_tx(&mut self, tx: Vec<::models::BtcTx3>) {
    self.tx = Some(tx);
  }

  pub fn with_tx(mut self, tx: Vec<::models::BtcTx3>) -> Block3 {
    self.tx = Some(tx);
    self
  }

  pub fn tx(&self) -> Option<&Vec<::models::BtcTx3>> {
    self.tx.as_ref()
  }
  ...
  pub fn with_version(mut self, version: i32) -> Block3 {
    self.version = Some(version);
    self
  }
  ...
  pub fn with_version_hex(mut self, version_hex: String) -> Block3 {
    self.version_hex = Some(version_hex);
    self
  }
  ...
  pub fn with_weight(mut self, weight: i32) -> Block3 {
    self.weight = Some(weight);
    self
  }
