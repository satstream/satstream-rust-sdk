...
impl ChainTxStats {
  ...
  pub fn with_time(mut self, time: i32) -> ChainTxStats {
    self.time = Some(time);
    self
  }
  ...
  pub fn with_txcount(mut self, txcount: i32) -> ChainTxStats {
    self.txcount = Some(txcount);
    self
  }
  ...
  pub fn with_txrate(mut self, txrate: f32) -> ChainTxStats {
    self.txrate = Some(txrate);
    self
  }
  ...
  pub fn with_window_block_count(mut self, window_block_count: i32) -> ChainTxStats {
    self.window_block_count = Some(window_block_count);
    self
  }
  ...
  pub fn with_window_final_block_hash(mut self, window_final_block_hash: String) -> ChainTxStats {
    self.window_final_block_hash = Some(window_final_block_hash);
    self
  }
  ...
  pub fn with_window_final_block_height(mut self, window_final_block_height: i32) -> ChainTxStats {
    self.window_final_block_height = Some(window_final_block_height);
    self
  }
  ...
  pub fn with_window_interval(mut self, window_interval: i32) -> ChainTxStats {
    self.window_interval = Some(window_interval);
    self
  }
  ...
  pub fn with_window_tx_count(mut self, window_tx_count: i32) -> ChainTxStats {
    self.window_tx_count = Some(window_tx_count);
    self
  }
