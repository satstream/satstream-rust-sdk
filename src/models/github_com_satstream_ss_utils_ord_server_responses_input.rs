...
pub struct GithubComSatstreamSsUtilsOrdServerResponsesInput {
...
impl GithubComSatstreamSsUtilsOrdServerResponsesInput {
  pub fn new() -> GithubComSatstreamSsUtilsOrdServerResponsesInput {
  ...
  pub fn with_previous_output(mut self, previous_output: String) -> GithubComSatstreamSsUtilsOrdServerResponsesInput {
    self.previous_output = Some(previous_output);
    self
  }
  ...
  pub fn with_script_sig(mut self, script_sig: String) -> GithubComSatstreamSsUtilsOrdServerResponsesInput {
    self.script_sig = Some(script_sig);
    self
  }
  ...
  pub fn with_sequence(mut self, sequence: i32) -> GithubComSatstreamSsUtilsOrdServerResponsesInput {
    self.sequence = Some(sequence);
    self
  }
  ...
  pub fn with_witness(mut self, witness: Vec<String>) -> GithubComSatstreamSsUtilsOrdServerResponsesInput {
    self.witness = Some(witness);
    self
  }
