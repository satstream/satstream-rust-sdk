...
pub struct MempoolDescendantsData {
...
impl MempoolDescendantsData {
  pub fn new() -> MempoolDescendantsData {
  ...
  pub fn with_detailed(mut self, detailed: ::std::collections::HashMap<String, ::models::MempoolEntry>) -> MempoolDescendantsData {
    self.detailed = Some(detailed);
    self
  }
  ...
  pub fn with_txids(mut self, txids: Vec<String>) -> MempoolDescendantsData {
    self.txids = Some(txids);
    self
  }
