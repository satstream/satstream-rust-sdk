...
pub struct GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
...
impl GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
  pub fn new() -> GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
  ...
  pub fn with_bip30(mut self, bip30: f32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
    self.bip30 = Some(bip30);
    self
  }
  ...
  pub fn with_genesis_block(mut self, genesis_block: f32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
    self.genesis_block = Some(genesis_block);
    self
  }
  ...
  pub fn with_scripts(mut self, scripts: f32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
    self.scripts = Some(scripts);
    self
  }
  ...
  pub fn with_unclaimed_rewards(mut self, unclaimed_rewards: f32) -> GithubComSatstreamSsUtilsBitcoinCliUtxoUnspendables {
    self.unclaimed_rewards = Some(unclaimed_rewards);
    self
  }
