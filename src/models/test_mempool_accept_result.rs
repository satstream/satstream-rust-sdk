...
pub struct TestMempoolAcceptResult {
  ...
  allowed: Option<bool>,
  #[serde(rename = "fees")]
  fees: Option<::models::TestMempoolAcceptResultFees>,
...
impl TestMempoolAcceptResult {
  pub fn new() -> TestMempoolAcceptResult {
  ...
  pub fn with_allowed(mut self, allowed: bool) -> TestMempoolAcceptResult {
    self.allowed = Some(allowed);
    self
  }
  ...
  pub fn set_fees(&mut self, fees: ::models::TestMempoolAcceptResultFees) {
    self.fees = Some(fees);
  }

  pub fn with_fees(mut self, fees: ::models::TestMempoolAcceptResultFees) -> TestMempoolAcceptResult {
    self.fees = Some(fees);
    self
  }

  pub fn fees(&self) -> Option<&::models::TestMempoolAcceptResultFees> {
    self.fees.as_ref()
  }
  ...
  pub fn with_package_error(mut self, package_error: String) -> TestMempoolAcceptResult {
    self.package_error = Some(package_error);
    self
  }
  ...
  pub fn with_reject_reason(mut self, reject_reason: String) -> TestMempoolAcceptResult {
    self.reject_reason = Some(reject_reason);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> TestMempoolAcceptResult {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_vsize(mut self, vsize: i32) -> TestMempoolAcceptResult {
    self.vsize = Some(vsize);
    self
  }
  ...
  pub fn with_wtxid(mut self, wtxid: String) -> TestMempoolAcceptResult {
    self.wtxid = Some(wtxid);
    self
  }
