...
pub struct GithubComSatstreamSsUtilsBitcoinCliBip32Deriv {
...
impl GithubComSatstreamSsUtilsBitcoinCliBip32Deriv {
  pub fn new() -> GithubComSatstreamSsUtilsBitcoinCliBip32Deriv {
  ...
  pub fn with_master_fingerprint(mut self, master_fingerprint: String) -> GithubComSatstreamSsUtilsBitcoinCliBip32Deriv {
    self.master_fingerprint = Some(master_fingerprint);
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> GithubComSatstreamSsUtilsBitcoinCliBip32Deriv {
    self.path = Some(path);
    self
  }
