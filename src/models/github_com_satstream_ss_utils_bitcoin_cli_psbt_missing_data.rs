...
pub struct GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
...
impl GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
  pub fn new() -> GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
  ...
  pub fn with_pubkeys(mut self, pubkeys: Vec<String>) -> GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
    self.pubkeys = Some(pubkeys);
    self
  }
  ...
  pub fn with_redeemscript(mut self, redeemscript: String) -> GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
    self.redeemscript = Some(redeemscript);
    self
  }
  ...
  pub fn with_signatures(mut self, signatures: Vec<String>) -> GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
    self.signatures = Some(signatures);
    self
  }
  ...
  pub fn with_witnessscript(mut self, witnessscript: String) -> GithubComSatstreamSsUtilsBitcoinCliPsbtMissingData {
    self.witnessscript = Some(witnessscript);
    self
  }
