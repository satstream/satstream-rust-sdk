...
pub struct InlineResponse2001 {
  #[serde(rename = "data")]
  data: Option<::models::AddressResponse>,
...
impl InlineResponse2001 {
  ...
  pub fn set_data(&mut self, data: ::models::AddressResponse) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::AddressResponse) -> InlineResponse2001 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::AddressResponse> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse2001 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
