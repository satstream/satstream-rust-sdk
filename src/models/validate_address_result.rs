...
impl ValidateAddressResult {
  pub fn new() -> ValidateAddressResult {
  ...
  pub fn with_address(mut self, address: String) -> ValidateAddressResult {
    self.address = Some(address);
    self
  }
  ...
  pub fn with_error(mut self, error: String) -> ValidateAddressResult {
    self.error = Some(error);
    self
  }
  ...
  pub fn with_error_locations(mut self, error_locations: Vec<i32>) -> ValidateAddressResult {
    self.error_locations = Some(error_locations);
    self
  }
  ...
  pub fn with_isscript(mut self, isscript: bool) -> ValidateAddressResult {
    self.isscript = Some(isscript);
    self
  }
  ...
  pub fn with_isvalid(mut self, isvalid: bool) -> ValidateAddressResult {
    self.isvalid = Some(isvalid);
    self
  }
  ...
  pub fn with_iswitness(mut self, iswitness: bool) -> ValidateAddressResult {
    self.iswitness = Some(iswitness);
    self
  }
  ...
  pub fn with_script_pub_key(mut self, script_pub_key: String) -> ValidateAddressResult {
    self.script_pub_key = Some(script_pub_key);
    self
  }
  ...
  pub fn with_witness_program(mut self, witness_program: String) -> ValidateAddressResult {
    self.witness_program = Some(witness_program);
    self
  }
  ...
  pub fn with_witness_version(mut self, witness_version: i32) -> ValidateAddressResult {
    self.witness_version = Some(witness_version);
    self
  }
