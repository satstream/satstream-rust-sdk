...
pub struct DecodedPsbtInput {
  ...
  bip32_derivs: Option<::std::collections::HashMap<String, ::models::Bip32Deriv>>,
  #[serde(rename = "final_scriptsig")]
  final_scriptsig: Option<::models::DecodedPsbtInputFinalScriptsig>,
  ...
  non_witness_utxo: Option<::models::DecodedPsbtInputNonWitnessUtxo>,
  ...
  witness_utxo: Option<::models::DecodedPsbtInputWitnessUtxo>
}

impl DecodedPsbtInput {
  pub fn new() -> DecodedPsbtInput {
    DecodedPsbtInput {
      bip32_derivs: None,
  ...
  pub fn set_bip32_derivs(&mut self, bip32_derivs: ::std::collections::HashMap<String, ::models::Bip32Deriv>) {
    self.bip32_derivs = Some(bip32_derivs);
  }

  pub fn with_bip32_derivs(mut self, bip32_derivs: ::std::collections::HashMap<String, ::models::Bip32Deriv>) -> DecodedPsbtInput {
    self.bip32_derivs = Some(bip32_derivs);
    self
  }

  pub fn bip32_derivs(&self) -> Option<&::std::collections::HashMap<String, ::models::Bip32Deriv>> {
  ...
  pub fn set_final_scriptsig(&mut self, final_scriptsig: ::models::DecodedPsbtInputFinalScriptsig) {
    self.final_scriptsig = Some(final_scriptsig);
  }

  pub fn with_final_scriptsig(mut self, final_scriptsig: ::models::DecodedPsbtInputFinalScriptsig) -> DecodedPsbtInput {
    self.final_scriptsig = Some(final_scriptsig);
    self
  }

  pub fn final_scriptsig(&self) -> Option<&::models::DecodedPsbtInputFinalScriptsig> {
  ...
  pub fn with_final_scriptwitness(mut self, final_scriptwitness: Vec<String>) -> DecodedPsbtInput {
    self.final_scriptwitness = Some(final_scriptwitness);
    self
  }
  ...
  pub fn set_non_witness_utxo(&mut self, non_witness_utxo: ::models::DecodedPsbtInputNonWitnessUtxo) {
    self.non_witness_utxo = Some(non_witness_utxo);
  }

  pub fn with_non_witness_utxo(mut self, non_witness_utxo: ::models::DecodedPsbtInputNonWitnessUtxo) -> DecodedPsbtInput {
    self.non_witness_utxo = Some(non_witness_utxo);
    self
  }

  pub fn non_witness_utxo(&self) -> Option<&::models::DecodedPsbtInputNonWitnessUtxo> {
  ...
  pub fn with_partial_signatures(mut self, partial_signatures: ::std::collections::HashMap<String, String>) -> DecodedPsbtInput {
    self.partial_signatures = Some(partial_signatures);
    self
  }
  ...
  pub fn with_redeem_script(mut self, redeem_script: ::models::DecodedPsbtInputRedeemScript) -> DecodedPsbtInput {
    self.redeem_script = Some(redeem_script);
    self
  }
  ...
  pub fn with_sighash(mut self, sighash: String) -> DecodedPsbtInput {
    self.sighash = Some(sighash);
    self
  }
  ...
  pub fn with_unknown(mut self, unknown: ::std::collections::HashMap<String, ::models::Object>) -> DecodedPsbtInput {
    self.unknown = Some(unknown);
    self
  }
  ...
  pub fn with_witness_script(mut self, witness_script: ::models::DecodedPsbtInputWitnessScript) -> DecodedPsbtInput {
    self.witness_script = Some(witness_script);
    self
  }
  ...
  pub fn set_witness_utxo(&mut self, witness_utxo: ::models::DecodedPsbtInputWitnessUtxo) {
    self.witness_utxo = Some(witness_utxo);
  }

  pub fn with_witness_utxo(mut self, witness_utxo: ::models::DecodedPsbtInputWitnessUtxo) -> DecodedPsbtInput {
    self.witness_utxo = Some(witness_utxo);
    self
  }

  pub fn witness_utxo(&self) -> Option<&::models::DecodedPsbtInputWitnessUtxo> {
