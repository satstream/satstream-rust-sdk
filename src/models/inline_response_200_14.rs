...
pub struct InlineResponse20014 {
  #[serde(rename = "data")]
  data: Option<::models::ChainTxStats>,
...
impl InlineResponse20014 {
  ...
  pub fn set_data(&mut self, data: ::models::ChainTxStats) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::ChainTxStats) -> InlineResponse20014 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::ChainTxStats> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20014 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
