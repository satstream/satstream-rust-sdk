...
pub struct InlineResponse2009 {
  #[serde(rename = "data")]
  data: Option<::models::BlockResponse>,
...
impl InlineResponse2009 {
  ...
  pub fn set_data(&mut self, data: ::models::BlockResponse) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::BlockResponse) -> InlineResponse2009 {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::BlockResponse> {
    self.data.as_ref()
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse2009 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
