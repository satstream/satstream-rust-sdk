...
impl InlineResponse20011 {
  ...
  pub fn with_data(mut self, data: i32) -> InlineResponse20011 {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20011 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
