...
impl InscriptionData {
  ...
  pub fn with_body(mut self, body: Vec<i32>) -> InscriptionData {
    self.body = Some(body);
    self
  }
  ...
  pub fn with_content_encoding(mut self, content_encoding: String) -> InscriptionData {
    self.content_encoding = Some(content_encoding);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: Vec<i32>) -> InscriptionData {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_delegate(mut self, delegate: String) -> InscriptionData {
    self.delegate = Some(delegate);
    self
  }
  ...
  pub fn with_duplicate_field(mut self, duplicate_field: bool) -> InscriptionData {
    self.duplicate_field = Some(duplicate_field);
    self
  }
  ...
  pub fn with_incomplete_field(mut self, incomplete_field: bool) -> InscriptionData {
    self.incomplete_field = Some(incomplete_field);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: String) -> InscriptionData {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_metaprotocol(mut self, metaprotocol: String) -> InscriptionData {
    self.metaprotocol = Some(metaprotocol);
    self
  }
  ...
  pub fn with_parents(mut self, parents: Vec<String>) -> InscriptionData {
    self.parents = Some(parents);
    self
  }
  ...
  pub fn with_pointer(mut self, pointer: String) -> InscriptionData {
    self.pointer = Some(pointer);
    self
  }
  ...
  pub fn with_rune(mut self, rune: String) -> InscriptionData {
    self.rune = Some(rune);
    self
  }
  ...
  pub fn with_unrecognized_even_field(mut self, unrecognized_even_field: bool) -> InscriptionData {
    self.unrecognized_even_field = Some(unrecognized_even_field);
    self
  }
