...
impl InlineResponse20036 {
  ...
  pub fn with_data(mut self, data: Vec<::models::TxSpendingPrevoutResult>) -> InlineResponse20036 {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_utils_response_envelope(mut self, utils_response_envelope: ::models::UtilsResponseEnvelope) -> InlineResponse20036 {
    self.utils_response_envelope = Some(utils_response_envelope);
    self
  }
