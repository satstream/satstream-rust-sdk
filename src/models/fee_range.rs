...
impl FeeRange {
  ...
  pub fn with_endrange(mut self, endrange: f32) -> FeeRange {
    self.endrange = Some(endrange);
    self
  }
  ...
  pub fn with_inmempool(mut self, inmempool: f32) -> FeeRange {
    self.inmempool = Some(inmempool);
    self
  }
  ...
  pub fn with_leftmempool(mut self, leftmempool: f32) -> FeeRange {
    self.leftmempool = Some(leftmempool);
    self
  }
  ...
  pub fn with_startrange(mut self, startrange: f32) -> FeeRange {
    self.startrange = Some(startrange);
    self
  }
  ...
  pub fn with_totalconfirmed(mut self, totalconfirmed: f32) -> FeeRange {
    self.totalconfirmed = Some(totalconfirmed);
    self
  }
  ...
  pub fn with_withintarget(mut self, withintarget: f32) -> FeeRange {
    self.withintarget = Some(withintarget);
    self
  }
