...
pub struct MiningApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> MiningApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> MiningApiClient<C> {
        MiningApiClient {
...
impl<C: hyper::client::Connect>MiningApi for MiningApiClient<C> {
    ...
    fn get_network_hashps(&self, request: ::models::RequestsGetNetworkHashPsRequest) -> Box<Future<Item = ::models::InlineResponse20013, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/mining/networkhashps?{}", configuration.base_path, query_string);
