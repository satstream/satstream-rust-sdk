...
pub struct RequestsGetMempoolAncestorsRequest {
...
impl RequestsGetMempoolAncestorsRequest {
  pub fn new() -> RequestsGetMempoolAncestorsRequest {
  ...
  pub fn with_txid(mut self, txid: String) -> RequestsGetMempoolAncestorsRequest {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_verbose(mut self, verbose: bool) -> RequestsGetMempoolAncestorsRequest {
    self.verbose = Some(verbose);
    self
  }
